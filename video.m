...
addpath(genpath('C:\Users\User\OneDrive - Technion\Msc\Thesis\Experiments')) % adds a folder to the path
LoadVideoName = '2nd_experiment\Experiment02_ODVS_a.avi'; % Name of a video file
SaveVideoName = 'saved data\MyTrackingResults_Experiment02_ODVS_a.avi'; % Name of video results file
